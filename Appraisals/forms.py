...
class CreateCareerDiscussionForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
            ...
            "Q4": "What are some of the developmental activities?",
...
class MidAppGoalsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
            ...
            "MID_user_comments": "Mid Year Employee's Comments",
...
class MidAppGoalsForm_M(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
            ...
            "tracking_status": "Status",
            "MID_user_comments": "Mid Year Employee's Comments",
            "MID_manager_comments": "Mid Year Manager's Comments",
        }
...
class AppGoalsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
            ...
            "user_rating": "End Year Employee's Self Rating",
            "user_comments": "End Year Employee's Comments",
        }
...
class MAppGoalsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
            "summary": "Goal Title",
            "description": "Objective",
            "user_rating": "End Year Employee's Rating",
            "user_comments": "End Year Employee's Comments", 
            "manager_rating": "End Year Manager Rating",
            "manager_comments": "End Year Manager Comments",
            "MID_user_comments": "Mid-Year Review Comments (Employee)",
            "MID_manager_comments": "Mid-Year Review Comments (Manager)", 
        }
